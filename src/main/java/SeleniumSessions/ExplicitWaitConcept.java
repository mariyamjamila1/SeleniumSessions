...
public class ExplicitWaitConcept {
	...
	public static void main(String[] args) {
		...
		//2b: Explicit Wait : dynamic //if element isn't found after waiting, timeOutException is thrown
		//2b.1: WebDriverWait
		//2b.2: FluentWait
		//--waiting for a specific Web element to appear, not a global wait
